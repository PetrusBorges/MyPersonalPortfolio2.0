...
const ErrorMessage = () => {
  ...
  return (
    <div className='flex items-center flex-col w-[310px] justify-start bg-neutral-700 h-96 rounded-xl border-2 border-neutral-800 shadow-2xl shadow-neutral-900'>
