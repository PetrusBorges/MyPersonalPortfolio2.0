...
const Navbar = () => {
  return (
    <nav
      className='shadow-2xl border-2 border-neutral-800 backdrop-blur bg-white/5 flex items-center justify-center gap-1 p-2 rounded-full absolute bottom-5 duration-500 hover:border-transparent'
    >
      <NavbarButton 
        isButton
