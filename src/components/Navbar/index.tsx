...
const Navbar = () => {
  return (
    <nav
      className='border-2 border-neutral-700 hover:border-transparent w-[310px] flex items-center justify-center gap-1 p-2 rounded-full fixed bottom-7 duration-500'
    >
      <NavbarButton
        isButton
